...
##
## This file contains the test cases for population kind 7 (NAPopulationNodeDP7)
##
...
proc test1() =
    ...
    var population: NCNodeDataProcessor = naInitPopulationNodeDP7(individual1, config1)
