...
##
## This file contains the test cases for population kind 4 (NAPopulationNodeDP4)
##
...
proc test1() =
    ...
    var population: NCNodeDataProcessor = naInitPopulationNodeDP4(individual1, config1)
