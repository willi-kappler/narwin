...
##
## This file contains the test cases for population kind 3 (NAPopulationNodeDP3)
##
...
proc test1() =
    ...
    var population: NCNodeDataProcessor = naInitPopulationNodeDP3(individual1, config1)
