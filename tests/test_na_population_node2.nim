...
##
## This file contains the test cases for population kind 2 (NAPopulationNodeDP2)
##
...
proc test1() =
    ...
    var population: NCNodeDataProcessor = naInitPopulationNodeDP2(individual1, config1)
